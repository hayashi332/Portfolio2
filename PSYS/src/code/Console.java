...
public class Console {
	...
	private HashMap<String, Console> nextStatus;
	// 終了状態であるかどうかを表す変数
	 ...
	 */
	Console( String firstMess, String promptMess, boolean IsEndStatus ) {
		this.nextStatus = new HashMap<String, Console>();
	...
	// 終了状態かどうかをチェックする
		 ...
		 */
		public void setNextStatus( String s, Console c ) {
			nextStatus.put( s, c );
		}
